test_that("ODBC.Storage.Service() should not throw error when a valid configuration is provided", {
  # Given
...
test_that("ODBC.Storage.Service() should throw error when no configuration provided", {
  # Given
...
test_that("ODBC.Storage.Service() should return a list of services", {
  # Given
  configurator <- Configuration.Service()
  configuration <- configurator[["GetODBCConfiguration"]]()

  services <- configuration |> ODBC.Storage.Service()
...
test_that("List of services returned from ODBC.Storage.Service() should includes Todo Select service", {
  # Given
  configurator <- Configuration.Service()
  configuration <- configurator[["GetODBCConfiguration"]]()

  service <- configuration |> ODBC.Storage.Service()
...
test_that("List of services returned from ODBC.Storage.Service() should includes Todo SelectWhereId service", {
  # Given
  configurator <- Configuration.Service()
  configuration <- configurator[["GetODBCConfiguration"]]()
...
test_that("List of services returned from ODBC.Storage.Service should include Todo Insert",{
  # Given
  configurator <- Configuration.Service()
  configuration <- configurator[["GetODBCConfiguration"]]()
...
test_that("List of services returned from ODBC.Storage.Service should include Todo Update",{
  # Given
  configurator <- Configuration.Service()
  configuration <- configurator[["GetODBCConfiguration"]]()
...
test_that("List of services returned from ODBC.Storage.Service should include Todo Delete",{
  # Given
  configurator <- Configuration.Service()
  configuration <- configurator[["GetODBCConfiguration"]]()
